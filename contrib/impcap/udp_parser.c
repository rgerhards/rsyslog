...
void udp_parse(const uchar *packet, size_t pktSize, struct json_object *jparent){
  ...
  json_object_object_add(jparent, "net_dst_port", json_object_new_int(ntohs(udp_header->uh_sport)));
  json_object_object_add(jparent, "net_flags", json_object_new_int(ntohs(udp_header->uh_dport)));
