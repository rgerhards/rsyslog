#!/bin/bash
# Prove the selected ConcurrentArray core retains untransferred work while a
# constrained segmented child applies pressure. Two fill/drain cycles plus exact unordered IDs are
