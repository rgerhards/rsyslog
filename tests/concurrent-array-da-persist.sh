...
#
# Verify the selected ConcurrentArray core through both unchanged DA children.
# A fast immediate stop must leave durable classic/segmented child state; restart must
