...
input(type="imptcp" port="13514" ruleset="remote" framing.delimiter.regex="^<[0-9]{3}>")
...
NEWMSG: <133>Mar  1 01:00:00 172.20.245.8 tag test xml-ish
<test/>
NEWMSG: <133>Mar  1 01:00:00 172.20.245.8 tag test2
NEWMSG: <133>Mar  1 01:00:00 172.20.245.8 tag multi
line1
NEWMSG: <133>Mar  1 01:00:00 172.20.245.8 tag multi
 l
 i
...
NEWMSG: <133>Mar  1 01:00:00 172.20.245.8 tag multi
line3
NEWMSG: <133>Mar  1 01:00:00 172.20.245.8 tag test4' | cmp - rsyslog.out.log
if [ ! $? -eq 0 ]; then
